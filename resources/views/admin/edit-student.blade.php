            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <form action="{{ route('update-student',$student->id) }}" method="post" class="mt-4">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="village" name="village" value="{{ old('village', $student->village ?? '' ) }}" placeholder="Village" /> />
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="taluko" name="taluko" value="{{ old('taluko', $student->taluko ?? '' ) }}" placeholder="Taluko" />
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="district" name="district" value="{{ old('district', $student->district ?? '' ) }}" placeholder="District" />
                        ...
                        <div class="form-floating mb-3">
                            <input type="tel" class="form-control" id="phone_number" name="phone_number"
                                value="{{ old('phone_number', $student->phone_number ?? '' ) }}" placeholder="Phone Number" />
                        ...
                        <div class="form-floating mb-3">
                            <input type="tel" class="form-control" id="parent_number" name="parent_number"
                                value="{{ old('parent_number', $student->parent_number ?? '' ) }}" placeholder="Parent's Phone Number" />
                        ...
                        <div class="form-floating mb-3">
                            ...
                            value="{{ old('parent_email', $student->parent_email ?? '' ) }}" placeholder="Parent's Email" />
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" id="address" name="address" placeholder="Address"
                                style="height: 100px">value="{{ old('address', $student->address ?? '' ) }}" </textarea>
