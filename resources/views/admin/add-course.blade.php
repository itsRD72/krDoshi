            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <form action="{{ route('add-course') }}" method="post" class="mt-4">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="maxstudent" name="max_student" placeholder="Maximum Students" />
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="lengthinweek" name="length_in_week" placeholder="Length In Week" />
